...
const FundCard = ({
  ...
  return (
    <div
      className="w-full sm:max-w-[288px] rounded-[15px] bg-[#1c1c24] cursor-pointer"
      onClick={handleClick}
    >
      <img
        src={image}
      ...
      <div className="flex flex-col p-4">
        ...
        {/* Target Amount and Days Left */}
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">
              {amountCollected}
            </h4>
            <p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] truncate">
              Raised of {target}
            </p>
          </div>
          <div className="flex flex-col">
